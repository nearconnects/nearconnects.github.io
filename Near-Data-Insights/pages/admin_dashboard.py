...
# Add database operations section
st.markdown("---")
...
st.markdown("### 🔌 Database Connection Information")
st.info("Connected to PostgreSQL database. All data is being stored persistently.")